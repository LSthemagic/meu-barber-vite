	...
	useEffect(() => {
		...
		if (navigator.geolocation) {
			navigator.geolocation.getCurrentPosition(
				...
				(error) => {
					console.error(
						"Erro ao obter a localização atual:",
						error.message
					);
				}
			);
						...
						{activeStep === 0 ? (
							<div className="form-group">
								...
								>
									...
									>
										Nunca vamos compartilhar seu email, com
										ninguém.
									</small>
									<br />
							...
							<div className="form-group">
								...
								>
									...
									<Form.Control
										...
										value={valor}
										onChange={(e) =>
											handleSearchBarberShop(
												e.target.value
											)
										}
									/>
									<small>
										Para garantir que sua barbearia seja
										encontrada, certifique-se de cadastrá-la
										em um aplicativo de localização.
									</small>
