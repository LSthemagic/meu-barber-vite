...
BarberSchema.methods.adicionarOuAtualizarCliente = async function (clienteData) {
  const existingCliente = this.clientes.find((cliente) => cliente.email === clienteData.email);
