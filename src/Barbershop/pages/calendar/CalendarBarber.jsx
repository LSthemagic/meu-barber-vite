...
const Calendar = () => {
    ...
    const handleGetInvalidHoursDB = async (emailBarber) => {
        setIsLoading(true)
        try {
            const response = await axios.get(`${path_url.local}/dataBarber/unavailableTimeBarber`, {
                headers: {
    ...
    const handlePostTimeUnavailable = async () => {
        ...
        setIsLoading(true)
        try {
            const response = await fetch(`${path_url.local}/calendar/unavailableTime`, {
                method: "POST",
                headers: {
    ...
    const handleGetBarbers = async () => {
        setIsLoading(true)
        try {
            const response = await axios.get(`${path_url.local}/dataBarber/barbersPerBarbershop`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                        id: dataBarber._id
