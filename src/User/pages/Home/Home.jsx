...
const Home = () => {
	...
	const handleWaze = (data) => {
		...
		window.open(
			`https://www.waze.com/location?ll=${latitude},${longitude}`
		);
	};
		...
		return (
			...
			>
				...
				<Modal.Footer>
					<Button
						variant="secondary"
						onClick={handleOffModalCalendar}
					>
						Close
					</Button>
