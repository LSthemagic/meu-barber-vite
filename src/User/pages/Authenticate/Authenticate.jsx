            ...
            <div style={{opacity:"93%"}} className={`card ${styles.card}`}>
                <div className="form-group">
                    <form className={styles.input} onSubmit={handleSubmit}>
                        <h1 style={{ fontFamily: 'cursive', alignItems: "center", justifyContent: "center", display: "flex" }}>Entrar</h1>
                        ...
                        <div className={styles.link}>
                            <Link to="/register" className={styles.link} >Sou novo aqui</Link>
                            <Link className={styles.link}>Esqueci minha senha</Link>
                        </div>

                        <button style={{ marginTop: '4%' }} className="btn btn-primary" type="submit">Entrar</button>
                    </form>
                </div>
            </div>
        </div>
